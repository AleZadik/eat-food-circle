<template>
    ...
    <Sidebar v-model:visible="visibleLeft" :dismissable="false" :modal="false" :showCloseIcon="true">
        <!-- Create a list of restaurants near me -->
    ...
    <!-- Simple login screen with a card in the middle -->
    <!-- Only Email, Name, and Location inputs -->
    <div>
        <h5>Addons</h5>
...
<style>
/* css styling for vant components */
/* Card in the middle of the page with border, shadow, and curved edges */
</style>